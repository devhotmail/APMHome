...
INSERT INTO i18n_message(id,msg_type,msg_key,value_zh, value_en, value_tw, site_id)  VALUES ('277', 'label', 'AssetBrowser', '设备分布分析', 'Asset Browser', null, '-1');
INSERT INTO i18n_message(id,msg_type,msg_key,value_zh, value_en, value_tw, site_id)  VALUES ('278', 'label', 'UsageAndClinicalPerformance', '运用与临床绩效', 'Usage And Clinical Performance', null, '-1');
INSERT INTO i18n_message(id,msg_type,msg_key,value_zh, value_en, value_tw, site_id)  VALUES ('279', 'label', 'FinancialPerformanceAndForecast', '财务绩效与预测', 'Financial Performance And Forcast', null, '-1');
...
INSERT INTO i18n_message(id,msg_type,msg_key,value_zh, value_en, value_tw, site_id)  VALUES ('424', 'label', 'AssetTagMsgSubscriber', '维修事件消息订阅', 'AssetTagMsgSubscriber', null, '-1');
...
INSERT INTO i18n_message(id,msg_type,msg_key,value_zh, value_en, value_tw, site_id)  VALUES ('5076', 'label', 'ImportAssetDataFile', '批量导入资产数据', 'Import Asset Data File', null, '-1');
...
INSERT INTO i18n_message(id,msg_type,msg_key,value_zh, value_en, value_tw, site_id)  VALUES ('5624', 'label', 'StaffPerformance', '人员绩效分析', 'Staff Performance Analysis', null, '-1');
INSERT INTO i18n_message(id,msg_type,msg_key,value_zh, value_en, value_tw, site_id)  VALUES ('5625', 'label', 'FailureAnalysis', '设备故障分析', 'Failure Analysis', null, '-1');
INSERT INTO i18n_message(id,msg_type,msg_key,value_zh, value_en, value_tw, site_id)  VALUES ('5626', 'label', 'ProcessAnalysis', '维修流程分析', 'Process Analysis', null, '-1');
INSERT INTO i18n_message(id,msg_type,msg_key,value_zh, value_en, value_tw, site_id)  VALUES ('5627', 'label', 'MaintenanceCost', '维修成本分析', 'Maintenance Cost', null, '-1');
