...
return "success";
    ...
    private void extractor(Date date, List<AssetSummit> asmList, AssetClinicalRecordPojo accrp, AssetSummit asm1) {
        AssetInfo assetInfo = assetInfoRepository.findById(accrp.getAssetIds());
        ...
        asm1.setDeptId(assetInfo.getClinicalDeptId());
        asm1.setAssetGroup(assetInfo.getAssetGroup());
