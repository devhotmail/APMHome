...
public class I18nMessage implements Serializable, Comparable {
    ...
    public I18nMessage(Integer id, String msgType, Object msgKey, String valueZh, String valueEn, String valueTw, Integer institutionId) {
        this.id = id;
    ...
    public String toString() {
        return "I18nMessage{" + "msgType=" + msgType + ", msgKey=" + msgKey + ", valueZh=" + valueZh + ", valueEn=" + valueEn + ", institutionId=" + institutionId + '}';
    }
