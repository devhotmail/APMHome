...
import com.ge.aps.dao.PRoleRepository;
import com.ge.aps.domain.SysRole;
...
public class SysRoleController extends GenericCRUDController<SysRole> {
    ...
    PRoleRepository dao = null;

    @Override
    protected void init() {
        dao = WebUtil.getBean(PRoleRepository.class);
    }

    @Override
    protected PRoleRepository getDAO() {
        return dao;
    }
