...
public class CodeGenController implements Serializable {
    ...
    private String daoPath = "/src/main/java/com/ge/webris/dao/";
    private String viewControllerPath = "/src/main/java/com/ge/webris/view/";
    private String viewPagePath = "/src/main/webapp/ui/";    
    private String basePackage = "com.ge.webris";
