...
public class StoredProcedureBean extends StoredProcedure {
    ...
    protected final void initProc(final String sqlTypesClassName,
        ...
        for (Map<String, Object> parameter : parameters ) {
            ...
            if ("ResultSet".equalsIgnoreCase(parameterType)) {
                ...
                try {
                    ...
                    throw new IllegalArgumentException("Unable to derive parameter type: "+parameterType);
                }
            }
    ...
    public StoredProcedureBean(final DataSource dataSource,
        ...
        initProc(sqlTypesClassName, isFunction, parameters);
    }
