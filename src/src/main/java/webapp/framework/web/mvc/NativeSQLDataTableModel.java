...
public abstract class NativeSQLDataTableModel<T> extends LazyDataModel<T> {
    private static final long serialVersionUID = 1L;
    protected static final Logger logger = Logger.getLogger(NativeSQLDataTableModel.class);
