    ...
    var RongIMVoice = (function () {
        ...
        RongIMVoice.init = function () {
            if (this.isIE && false) {
                ...
                script.src = "../../../resources/js/swfobject-2.0.0.min.js";
                ...
                setTimeout(function () {
                    ...
                    swfobject.embedSWF("../../../resources/js/player-2.0.2.swf", "flashContent", "1", "1", swfVersionStr, null, flashvars, params, attributes);
                }, 200);
            }
            else {
...
//                }
        ...
        RongIMVoice.play = function (data, duration) {
            ...
            var me = this;
            if (me.isIE && false) {
                var movie = me.thisMovie();
                movie.doAction("init", data);
            }
            else {
                me.palyVoice(data);
        ...
        RongIMVoice.palyVoice = function (base64Data) {
            ...
            reader.onload = function () {
                var samples = new AMR({benchmark: true}).decode(reader.result);
